...
test('Purchase MTN SMS Bundles successfully.', async ({ page }) => {
    ...
    await expect(page.getByText('SMS bundle for MTN was submitted successfully.')).toBeVisible({timeout:150000});
