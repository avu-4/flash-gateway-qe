...
test('Purchase Telkom Data Bundles successfully.', async ({ page }) => {
    ...
    await expect(page.getByText('Data bundle for Telkom was submitted successfully.')).toBeVisible({timeout:150000});
})