...
test('Purchase Cell C Data Bundles successfully.', async ({ page }) => {
    ...
    await expect(page.getByText('Data bundle for Cell C was submitted successfully.')).toBeVisible({timeout:150000});
})