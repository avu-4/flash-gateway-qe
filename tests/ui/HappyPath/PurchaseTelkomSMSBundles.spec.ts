...
test('Purchase Telkom SMS Bundles successfully.', async ({ page }) => {
    ...
    await page.getByRole('button', {name: 'Telkom'}).click();
    ...
    await expect(page.getByText('SMS bundle for Telkom was submitted successfully.')).toBeVisible({timeout:150000});
